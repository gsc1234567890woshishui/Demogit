 ...
 */
public class TestRv extends BaseActivity implements View.OnClickListener{
    ...
    protected void initData() {
      ...
      //  myAdapter = new MyAdapter(this, sum);
        rvAdapter = new MyRvAdapter(sum);
        lv.setAdapter(rvAdapter);
        rvAdapter.setOn(new OnItemListenr() {
            @Override
            public void OnItem(int pos, View view) {
                CheckBoxBean checkBoxBean5 = sum.get(pos);
                System.out.println("---------xxx"+pos+checkBoxBean5.getIcheck());
